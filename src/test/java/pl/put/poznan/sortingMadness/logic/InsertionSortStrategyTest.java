...
class InsertionSortStrategyTest {
    private InsertionSortStrategy insertionSortStrategy = new InsertionSortStrategy();
    ...
    void testCountingSortStrategy(){
        int[] result = insertionSortStrategy.sorting(inputIntegers);
        Assertions.assertTrue(Arrays.equals(expectedResultIntegers, result));
    }

    @Test
    void testTextCountingSortStrategy(){
        String[] result = insertionSortStrategy.sortingText(inputStrings);
    ...
    void testObjectCountingSortStrategy(){
        ...
        JSONObject[] result = insertionSortStrategy.sortingObject(inputObjects, sortingAttribute);
