...
class BubbleSortStrategyTest {
    private BubbleSortStrategy bubbleSortStrategy = new BubbleSortStrategy();
    ...
    void testCountingSortStrategy(){
        int[] result = bubbleSortStrategy.sorting(inputIntegers);
        Assertions.assertTrue(Arrays.equals(expectedResultIntegers, result));
    }

    @Test
    void testTextCountingSortStrategy(){
        String[] result = bubbleSortStrategy.sortingText(inputStrings);
    ...
    void testObjectCountingSortStrategy(){
        ...
        JSONObject[] result = bubbleSortStrategy.sortingObject(inputObjects, sortingAttribute);
