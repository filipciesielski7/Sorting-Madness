...
class QuickSortStrategyTest {
    private QuickSortStrategy quickSortStrategy = new QuickSortStrategy();
    ...
    void testBubbleSortStrategy(){
        int[] result = quickSortStrategy.sorting(inputIntegers);
        Assertions.assertTrue(Arrays.equals(expectedResultIntegers, result));
    }

    @Test
    void testTextBubbleSortStrategy(){
        String[] result = quickSortStrategy.sortingText(inputStrings);
    ...
    void testObjectBubbleSortStrategy(){
        ...
        JSONObject[] result = quickSortStrategy.sortingObject(inputObjects, sortingAttribute);
